def get_shop_list_from_dishes(dishes, person_count):
    ...
    # содержащих информацию об ингридинте блюда
    ...
    # "ingridient_name"
    # ingridients[ingridient["ingridient_name"]]["quanity"] += ingridient["quanity"] * person_count
    # это прибавление количетсва ингридинта, необходимого для блюда,
    # умноженного на количество людей person_count, к уже имеющемуся количетву,
